    ...
    return (
      <footer>
        ...
        <div className="allFooterLinks">
          <a href="index.html" className="footerLink">
            Po&#x10D;etna<span className="whiteDot">&#183;</span>
          </a>
          <a href="kuhinje.html" className="footerLink">
          Kuhinje <span className="whiteDot">&#183;</span>
          </a>
          <a href="adaptacije.html" className="footerLink">
            Adaptacije <span className="whiteDot">&#183;</span>
          </a>
          <a href="kontakt.html" className="footerLink">
            Kontakt <span className="whiteDot">&#183;</span>
          </a>
